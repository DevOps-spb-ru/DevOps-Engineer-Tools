...
func newRootCommand(stdout, stderr io.Writer) *cobra.Command {
  ...
  * веб-интерфейс и API для тех же операций.

В 0.1.0 доступны команды doctor и version; команды бэкапа, восстановления и
клонирования, каталог бэкапов с политикой хранения и веб-интерфейс появятся в 0.2.0.
