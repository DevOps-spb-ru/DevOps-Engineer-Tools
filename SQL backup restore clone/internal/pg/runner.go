...
//
// Файлы пакета: argv.go — сборка аргументов, dbname.go — проверка имён и
// идентификаторов бэкапов, sql.go — служебные запросы к каталогу,
// databases.go — операции с базами, dump.go и restore.go — дамп и восстановление,
// wait.go — ожидание готовности сервера, parse.go — разбор вывода утилит.
package pg
