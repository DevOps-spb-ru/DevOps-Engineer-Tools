...
// fse-1234. Префикс fse- в шаблоне обязателен: он отделяет стенды от остальных
// баз кластера, поэтому служебные базы (postgres, template0, template1) и базы
// других приложений не попадают ни в бэкапы, ни в восстановление.
const DefaultAllowPattern = `^fse-[a-z0-9][a-z0-9-]{0,40}$`
